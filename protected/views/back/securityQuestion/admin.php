<style type="text/css">
    ...
    #security-question-grid_c0, #security-question-grid_c2, #security-question-grid_c3 { width: 10%; }
</style>
...
<div class="row">
    ...
    $this->breadcrumbs = array(
        Yii::t('member_attribute', 'Security Questions') => array('admin'),
        Yii::t('application', 'Manage'),
    );
    $this->widget('application.widgets.backend.CBreadcrumbs', array('links'=>$this->breadcrumbs));

    $this->menu = array(
        array('label' => Yii::t('member_attribute', 'Create Security Question'), 'url' => array('create')),
    );
...
<div class="well">
    ...
    <h1><?php echo Yii::t('member_attribute', 'Manage Security Questions') ?></h1>
    ...
    <?php $this->widget('zii.widgets.grid.CGridView', array(
        ...
        'columns' => array(
            ...
            array(
                'name' => 'ques',
                'value' => function ($d) {
                        return Yii::app()->language == 'vi' ? $d->ques : $d->ques_en;
                    }
            ),
            'pos',
            array(
