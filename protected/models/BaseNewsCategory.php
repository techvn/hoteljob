 ...
 */
class BaseNewsCategory extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('name, members_id', 'required'),
			array('status, type, members_id', 'numerical', 'integerOnly'=>true),
			array('name, name_en, parent_id', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, name_en, parent_id, status, type, members_id', 'safe', 'on'=>'search'),
		);
	}
