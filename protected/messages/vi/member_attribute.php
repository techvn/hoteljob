...
return array(
    ...
    'Phone' => 'Điện thoại',
    'Mobile' => 'Di động',
    'Created Time' => 'Ngày tham gia',
    'Updated Time' => 'Thời gian cập nhật',
    'Status' => 'Trạng thái',
    'Gull Name' => 'Họ và tên',
    'Members Group' => 'Nhóm thành viên',
    'Security Ques' => 'Câu hỏi bí mật',
    'Security Ans' => 'Trả lời câu hỏi bí mật',
    'Recieve Mail' => 'Nhận email',
    'Province' => 'Tỉnh thành',
    'District' => 'Quận huyện',
    'Know Me' => 'Biết tới tôi qua',
    'Married' => 'Hôn nhân',
    'Avatar' => 'Ảnh đại diện',
    'Nationality' => 'Quốc tịch',
    'Username not null' => 'Tên đăng nhập không được rỗng',
    'Username must greater than {min} character and lesser than {max}' => 'Tên phải lớn hơn {min} và nhỏ hơn {max} ký tự',
